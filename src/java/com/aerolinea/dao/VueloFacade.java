...
public class VueloFacade extends AbstractFacade<Vuelo> {
    ...
    public List<Vuelo> consultarVuelos(String fecha1, String fecha2) {
        try {
            Date f1 = new SimpleDateFormat("dd-MM-yyyy").parse(fecha1);
            Date f2 = new SimpleDateFormat("dd-MM-yyyy").parse(fecha2);
